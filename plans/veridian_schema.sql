...
CREATE TABLE users (
    ...
    password            VARCHAR(128) NOT NULL,                -- Django-managed (ADR-0006): AbstractBaseUser makes this NOT NULL; OTP users store an unusable '!'-prefixed marker (never NULL), a real hash only for platform_admin bootstrap
