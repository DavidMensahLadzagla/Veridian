...
def test_create_user_requires_email_or_phone() -> None:
    with pytest.raises(ValueError):
        User.objects.create_user(full_name="No Contact")


@pytest.mark.django_db
def test_phone_only_user_defaults_to_patient_with_unusable_password() -> None:
...
@pytest.mark.django_db
def test_create_superuser_is_platform_admin_and_staff() -> None:
